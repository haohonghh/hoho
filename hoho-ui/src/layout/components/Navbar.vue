    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        ...
        <el-tooltip content="源码地址" effect="dark" placement="bottom">
          <hoho-git id="hoho-git" class="right-menu-item hover-effect" />
        </el-tooltip>

        <el-tooltip content="文档地址" effect="dark" placement="bottom">
          <hoho-doc id="hoho-doc" class="right-menu-item hover-effect" />
        </el-tooltip>
...
import HohoGit from '@/components/Hoho/Git'
import HohoDoc from '@/components/Hoho/Doc'
